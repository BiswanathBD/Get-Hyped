...
const Content = () => {
  return (
    <section className="px-4 lg:px-0 mt-24 lg:mt-48 lg:w-6/7 md:mx-auto">
      ...
      {/* cards */}
      <div className="flex flex-col sm:flex-row justify-between gap-8 sm:gap-[5vw] mt-16 mx-8 items-start">
        {cards.map((card, i) => (
          <motion.div
            whileHover={{ rotate: -3 }}
            ...
            className={`group relative flex-1 rounded-[7vw] sm:rounded-[3vw] sm:rotate-0 overflow-hidden border-[1.5vw] sm:border-[0.8vw] mb-[${i * 5}px]
